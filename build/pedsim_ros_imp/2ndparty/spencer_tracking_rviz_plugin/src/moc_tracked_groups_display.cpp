...
#include <memory>
#include "../../../../../src/pedsim_ros_imp/2ndparty/spencer_tracking_rviz_plugin/src/tracked_groups_display.h"
...
QT_INIT_METAOBJECT const QMetaObject spencer_tracking_rviz_plugin::TrackedGroupsDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<PersonDisplayCommon<spencer_tracking_msgs::TrackedGroups>::staticMetaObject>(),
