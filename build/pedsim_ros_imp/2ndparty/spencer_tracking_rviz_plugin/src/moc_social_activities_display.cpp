...
#include <memory>
#include "../../../../../src/pedsim_ros_imp/2ndparty/spencer_tracking_rviz_plugin/src/social_activities_display.h"
...
QT_INIT_METAOBJECT const QMetaObject spencer_tracking_rviz_plugin::SocialActivitiesDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<PersonDisplayCommon<spencer_social_relation_msgs::SocialActivities>::staticMetaObject>(),
