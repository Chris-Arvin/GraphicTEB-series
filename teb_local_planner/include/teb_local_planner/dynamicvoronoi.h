...
private:  
  ...
  // 这个函数和计算distanceMap已经没有关系啦，主要是在求voronoi map，仅改变每个cell的voronoi 和 pruneQueue；不改变distX，distY，sqdist等和distance map相关的东西  
  void commitAndColorize();
  //! 离点(x,y)最近的障碍物点是它自己 if true
