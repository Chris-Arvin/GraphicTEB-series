...
"""autogenerated by genpy from spencer_social_relation_msgs/SocialActivities.msg. Do not edit."""
import codecs
import sys
...
class SocialActivities(genpy.Message):
  _md5sum = "59f7b8ff037d2bbbd144704b9ef2b5be"
  _type = "spencer_social_relation_msgs/SocialActivities"
...
"""
  ...
  _slot_types = ['std_msgs/Header','spencer_social_relation_msgs/SocialActivity[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = spencer_social_relation_msgs.msg.SocialActivity()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
