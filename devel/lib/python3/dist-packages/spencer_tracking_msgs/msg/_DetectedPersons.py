...
"""autogenerated by genpy from spencer_tracking_msgs/DetectedPersons.msg. Do not edit."""
import codecs
import sys
...
class DetectedPersons(genpy.Message):
  _md5sum = "38e416cebb5dfd7363bde91113e7f3bd"
  _type = "spencer_tracking_msgs/DetectedPersons"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Message with all currently detected persons
#
...
"""
  ...
  _slot_types = ['std_msgs/Header','spencer_tracking_msgs/DetectedPerson[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DetectedPersons, self).__init__(*args, **kwds)
