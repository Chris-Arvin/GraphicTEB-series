...
"""
  ...
  _slot_types = ['std_msgs/Header','teb_local_planner/TrajectoryMsg[]','uint16','teb_local_planner/ObstacleArrayMsg']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.obstacles_msg is None:
        self.obstacles_msg = teb_local_planner.msg.ObstacleArrayMsg()
    else:
      self.header = std_msgs.msg.Header()
      self.trajectories = []
      self.selected_trajectory_idx = 0
