...
"""autogenerated by genpy from mbf_msgs/MoveBaseActionResult.msg. Do not edit."""
import codecs
import sys
...
class MoveBaseActionResult(genpy.Message):
  _md5sum = "3ba171ea938c4125488c9249510c56e0"
  _type = "mbf_msgs/MoveBaseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mbf_msgs/MoveBaseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = mbf_msgs.msg.MoveBaseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = mbf_msgs.msg.MoveBaseResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2f3I().pack(_x.result.dist_to_goal, _x.result.angle_to_goal, _x.result.final_pose.header.seq, _x.result.final_pose.header.stamp.secs, _x.result.final_pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.dist_to_goal, _x.result.angle_to_goal, _x.result.final_pose.header.seq, _x.result.final_pose.header.stamp.secs, _x.result.final_pose.header.stamp.nsecs,) = _get_struct_2f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.result.final_pose.pose.position.x, _x.result.final_pose.pose.position.y, _x.result.final_pose.pose.position.z, _x.result.final_pose.pose.orientation.x, _x.result.final_pose.pose.orientation.y, _x.result.final_pose.pose.orientation.z, _x.result.final_pose.pose.orientation.w,) = _get_struct_7d().unpack(str[start:end])
      return self
