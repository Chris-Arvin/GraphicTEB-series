...
"""autogenerated by genpy from mbf_msgs/RecoveryActionResult.msg. Do not edit."""
import codecs
import sys
...
class RecoveryActionResult(genpy.Message):
  _md5sum = "cae6c01476f7c64808fc85f9972a982e"
  _type = "mbf_msgs/RecoveryActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mbf_msgs/RecoveryResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RecoveryActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = mbf_msgs.msg.RecoveryResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = mbf_msgs.msg.RecoveryResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.used_plugin = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.used_plugin = str[start:end]
      return self
