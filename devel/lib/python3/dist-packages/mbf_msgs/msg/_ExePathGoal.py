...
"""autogenerated by genpy from mbf_msgs/ExePathGoal.msg. Do not edit."""
import codecs
import sys
...
class ExePathGoal(genpy.Message):
  _md5sum = "997d05ac3260fea4e2e2586ca47d2578"
  _type = "mbf_msgs/ExePathGoal"
...
float64 w
"""
  __slots__ = ['path','controller','concurrency_slot','tolerance_from_action','dist_tolerance','angle_tolerance']
  _slot_types = ['nav_msgs/Path','string','uint8','bool','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       path,controller,concurrency_slot,tolerance_from_action,dist_tolerance,angle_tolerance
    ...
    """
    if args or kwds:
      super(ExePathGoal, self).__init__(*args, **kwds)
      ...
      if self.tolerance_from_action is None:
        self.tolerance_from_action = False
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2B2f().pack(_x.concurrency_slot, _x.tolerance_from_action, _x.dist_tolerance, _x.angle_tolerance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.concurrency_slot, _x.tolerance_from_action, _x.dist_tolerance, _x.angle_tolerance,) = _get_struct_2B2f().unpack(str[start:end])
      self.tolerance_from_action = bool(self.tolerance_from_action)
      return self
