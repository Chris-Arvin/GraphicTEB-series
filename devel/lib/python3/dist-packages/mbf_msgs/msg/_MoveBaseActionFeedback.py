...
"""autogenerated by genpy from mbf_msgs/MoveBaseActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MoveBaseActionFeedback(genpy.Message):
  ...
  _type = "mbf_msgs/MoveBaseActionFeedback"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mbf_msgs/MoveBaseFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = mbf_msgs.msg.MoveBaseFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = mbf_msgs.msg.MoveBaseFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.last_cmd_vel.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
