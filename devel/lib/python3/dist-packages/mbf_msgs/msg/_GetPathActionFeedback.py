...
"""autogenerated by genpy from mbf_msgs/GetPathActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class GetPathActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "mbf_msgs/GetPathActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mbf_msgs/GetPathFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetPathActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = mbf_msgs.msg.GetPathFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = mbf_msgs.msg.GetPathFeedback()
