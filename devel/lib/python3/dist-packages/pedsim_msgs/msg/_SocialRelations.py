...
"""autogenerated by genpy from pedsim_msgs/SocialRelations.msg. Do not edit."""
import codecs
import sys
...
class SocialRelations(genpy.Message):
  ...
  _type = "pedsim_msgs/SocialRelations"
...
string      TYPE_FRIENDSHIP = "friendship\""""
  ...
  _slot_types = ['std_msgs/Header','pedsim_msgs/SocialRelation[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = pedsim_msgs.msg.SocialRelation()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
