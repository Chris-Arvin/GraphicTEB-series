...
struct TrajectoryMsg_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::teb_local_planner::TrajectoryPointMsg_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::teb_local_planner::TrajectoryPointMsg_<ContainerAllocator> >> _trajectory_type;
...
bool operator==(const ::teb_local_planner::TrajectoryMsg_<ContainerAllocator1> & lhs, const ::teb_local_planner::TrajectoryMsg_<ContainerAllocator2> & rhs)
{
