...
#ifndef __mbf_costmap_nav__MOVEBASEFLEXCONFIG_H__
#define __mbf_costmap_nav__MOVEBASEFLEXCONFIG_H__
  ...
  public:
    ...
    void setParams(MoveBaseFlexConfig &config, const std::vector<AbstractParamDescriptionConstPtr> params)
    {
      for (std::vector<AbstractParamDescriptionConstPtr>::const_iterator _i = params.begin(); _i != params.end(); ++_i)
      {
        ...
        if("shutdown_costmaps_delay"==(*_i)->name){shutdown_costmaps_delay = boost::any_cast<double>(val);}
...
double shutdown_costmaps_delay;
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(MoveBaseFlexConfig::AbstractParamDescriptionConstPtr(new MoveBaseFlexConfig::ParamDescription<bool>("shutdown_costmaps", "bool", 0, "Determines whether or not to shutdown the costmaps of the node when move_base_flex is in an inactive state", "", &MoveBaseFlexConfig::shutdown_costmaps)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(MoveBaseFlexConfig::AbstractParamDescriptionConstPtr(new MoveBaseFlexConfig::ParamDescription<bool>("shutdown_costmaps", "bool", 0, "Determines whether or not to shutdown the costmaps of the node when move_base_flex is in an inactive state", "", &MoveBaseFlexConfig::shutdown_costmaps)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.shutdown_costmaps_delay = 0.0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.shutdown_costmaps_delay = 60.0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.shutdown_costmaps_delay = 1.0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(MoveBaseFlexConfig::AbstractParamDescriptionConstPtr(new MoveBaseFlexConfig::ParamDescription<double>("shutdown_costmaps_delay", "double", 0, "How long in seconds to wait after last action before shutting down the costmaps", "", &MoveBaseFlexConfig::shutdown_costmaps_delay)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(MoveBaseFlexConfig::AbstractParamDescriptionConstPtr(new MoveBaseFlexConfig::ParamDescription<double>("shutdown_costmaps_delay", "double", 0, "How long in seconds to wait after last action before shutting down the costmaps", "", &MoveBaseFlexConfig::shutdown_costmaps_delay)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
