...
class RecoveryActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new RecoveryFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RecoveryFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RecoveryActionFeedback(null);
    ...
    data.feedback = RecoveryFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RecoveryActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = RecoveryFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new RecoveryFeedback()
    }
...
module.exports = RecoveryActionFeedback;
