...
class ExePathActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ExePathFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ExePathFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ExePathActionFeedback(null);
    ...
    data.feedback = ExePathFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ExePathFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExePathActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ExePathFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ExePathFeedback()
    }
...
module.exports = ExePathActionFeedback;
