...
class ExePathActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ExePathResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ExePathResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExePathActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = ExePathResult.Resolve(msg.result)
    }
    else {
      resolved.result = new ExePathResult()
    }
...
module.exports = ExePathActionResult;
