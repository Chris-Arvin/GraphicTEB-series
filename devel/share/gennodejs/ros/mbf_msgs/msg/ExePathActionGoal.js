...
class ExePathActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ExePathGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ExePathGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExePathActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ExePathGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ExePathGoal()
    }
...
module.exports = ExePathActionGoal;
