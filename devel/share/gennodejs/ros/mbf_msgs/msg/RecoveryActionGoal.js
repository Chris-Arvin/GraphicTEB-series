...
class RecoveryActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RecoveryGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += RecoveryGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RecoveryActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = RecoveryGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new RecoveryGoal()
    }
...
module.exports = RecoveryActionGoal;
