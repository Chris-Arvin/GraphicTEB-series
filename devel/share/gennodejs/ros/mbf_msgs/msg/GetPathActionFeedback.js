...
class GetPathActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new GetPathFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GetPathFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GetPathActionFeedback(null);
    ...
    data.feedback = GetPathFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetPathActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GetPathFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GetPathFeedback()
    }
...
module.exports = GetPathActionFeedback;
