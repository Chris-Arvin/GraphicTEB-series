...
class LineObstacles {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.obstacles.forEach((val) => {
      bufferOffset = LineObstacle.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LineObstacles(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.obstacles[i] = LineObstacle.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 48 * object.obstacles.length;
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LineObstacles(null);
    ...
    if (msg.obstacles !== undefined) {
      ...
      for (let i = 0; i < resolved.obstacles.length; ++i) {
        resolved.obstacles[i] = LineObstacle.Resolve(msg.obstacles[i]);
      }
    }
    else {
      resolved.obstacles = []
