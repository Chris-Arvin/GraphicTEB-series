...
class FeedbackMsg {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('obstacles_msg')) {
        ...
        this.obstacles_msg = new ObstacleArrayMsg();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ObstacleArrayMsg.serialize(obj.obstacles_msg, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.obstacles_msg = ObstacleArrayMsg.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ObstacleArrayMsg.getMessageSize(object.obstacles_msg);
    return length + 6;
  }
  ...
  static messageDefinition() {
    ...
    teb_local_planner/ObstacleArrayMsg obstacles_msg
    ...
    float64 z
    ================================================================================
    MSG: teb_local_planner/ObstacleArrayMsg
  ...
  static Resolve(msg) {
    ...
    if (msg.obstacles_msg !== undefined) {
      resolved.obstacles_msg = ObstacleArrayMsg.Resolve(msg.obstacles_msg)
    }
    else {
      resolved.obstacles_msg = new ObstacleArrayMsg()
    }
