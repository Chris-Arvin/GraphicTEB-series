...
if("TRUE" STREQUAL "TRUE")
  set(mbf_costmap_nav_SOURCE_PREFIX /home/arvin/Documents/pedsim_ws/src/mbf/mbf_costmap_nav)
  set(mbf_costmap_nav_DEVEL_PREFIX /home/arvin/Documents/pedsim_ws/devel)
  ...
  set(mbf_costmap_nav_INSTALL_PREFIX /home/arvin/Documents/pedsim_ws/install)
...
if(NOT "/home/arvin/Documents/pedsim_ws/devel/include;/home/arvin/Documents/pedsim_ws/src/mbf/mbf_costmap_nav/include;/usr/include " STREQUAL " ")
  set(mbf_costmap_nav_INCLUDE_DIRS "")
  set(_include_dirs "/home/arvin/Documents/pedsim_ws/devel/include;/home/arvin/Documents/pedsim_ws/src/mbf/mbf_costmap_nav/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mbf_costmap_nav' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arvin/Documents/pedsim_ws/src/mbf/mbf_costmap_nav/${idir}'.  ${_report}")
    endif()
    _list_append_unique(mbf_costmap_nav_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "mbf_costmap_server;/usr/lib/x86_64-linux-gnu/libboost_thread.so.1.74.0;/usr/lib/x86_64-linux-gnu/libboost_chrono.so.1.74.0")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(mbf_costmap_nav_EXPORTED_TARGETS ${${mbf_costmap_nav_dep}_EXPORTED_TARGETS})
endforeach()
