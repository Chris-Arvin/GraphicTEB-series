...
(cl:defclass <SocialRelations> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (elements
    :reader elements
    :initarg :elements
    :type (cl:vector spencer_social_relation_msgs-msg:SocialRelation)
   :initform (cl:make-array 0 :element-type 'spencer_social_relation_msgs-msg:SocialRelation :initial-element (cl:make-instance 'spencer_social_relation_msgs-msg:SocialRelation))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <SocialRelations>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SocialRelations)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name spencer_social_relation_msgs-msg:<SocialRelations> is deprecated: use spencer_social_relation_msgs-msg:SocialRelations instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SocialRelations>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'elements)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'spencer_social_relation_msgs-msg:SocialRelation))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SocialRelations>)))
  ...
  "spencer_social_relation_msgs/SocialRelations")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SocialRelations)))
  "Returns string type for a message object of type 'SocialRelations"
  "spencer_social_relation_msgs/SocialRelations")
