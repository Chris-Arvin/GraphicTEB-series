...
(cl:defclass <TrackedGroups> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (groups
    :reader groups
    :initarg :groups
    :type (cl:vector pedsim_msgs-msg:TrackedGroup)
   :initform (cl:make-array 0 :element-type 'pedsim_msgs-msg:TrackedGroup :initial-element (cl:make-instance 'pedsim_msgs-msg:TrackedGroup))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TrackedGroups>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrackedGroups)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pedsim_msgs-msg:<TrackedGroups> is deprecated: use pedsim_msgs-msg:TrackedGroups instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrackedGroups>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'groups)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'pedsim_msgs-msg:TrackedGroup))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TrackedGroups>)))
  ...
  (cl:format cl:nil "# Message with all currently tracked groups~%#~%~%Header              header      # Header containing timestamp etc. of this message~%pedsim_msgs/TrackedGroup[]      groups      # All groups that are currently being tracked~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: pedsim_msgs/TrackedGroup~%# Message defining a tracked group~%#~%~%uint64      group_id        # unique identifier of the target, consistent over time~%~%duration    age             # age of the group~%~%geometry_msgs/PoseWithCovariance    centerOfGravity   # mean and covariance of the group (calculated from its person tracks)~%~%uint64[]    track_ids       # IDs of the tracked persons in this group. See srl_tracking_msgs/TrackedPersons~%================================================================================~%MSG: geometry_msgs/PoseWithCovariance~%# This represents a pose in free space with uncertainty.~%~%Pose pose~%~%# Row-major representation of the 6x6 covariance matrix~%# The orientation parameters use a fixed-axis representation.~%# In order, the parameters are:~%# (x, y, z, rotation about X axis, rotation about Y axis, rotation about Z axis)~%float64[36] covariance~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TrackedGroups)))
  "Returns full string definition for message of type 'TrackedGroups"
  (cl:format cl:nil "# Message with all currently tracked groups~%#~%~%Header              header      # Header containing timestamp etc. of this message~%pedsim_msgs/TrackedGroup[]      groups      # All groups that are currently being tracked~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: pedsim_msgs/TrackedGroup~%# Message defining a tracked group~%#~%~%uint64      group_id        # unique identifier of the target, consistent over time~%~%duration    age             # age of the group~%~%geometry_msgs/PoseWithCovariance    centerOfGravity   # mean and covariance of the group (calculated from its person tracks)~%~%uint64[]    track_ids       # IDs of the tracked persons in this group. See srl_tracking_msgs/TrackedPersons~%================================================================================~%MSG: geometry_msgs/PoseWithCovariance~%# This represents a pose in free space with uncertainty.~%~%Pose pose~%~%# Row-major representation of the 6x6 covariance matrix~%# The orientation parameters use a fixed-axis representation.~%# In order, the parameters are:~%# (x, y, z, rotation about X axis, rotation about Y axis, rotation about Z axis)~%float64[36] covariance~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
