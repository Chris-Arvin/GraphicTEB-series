...
(cl:defclass <FeedbackMsg> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (obstacles_msg
    ...
    :type teb_local_planner-msg:ObstacleArrayMsg
    :initform (cl:make-instance 'teb_local_planner-msg:ObstacleArrayMsg)))
)
